          ...
          <div className="flex flex-wrap justify-center">
            {
              aboutCards.map((aboutCard, index) => {
                return (
                  <div key={index} className={`xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 lg:border-b-2 lg:border-teal-800 ${index !== aboutCards.length - 1 && `border-b-2 border-teal-800`} ${!!index && `lg:border-l-2 lg:border-teal-800`}`}>
